...
public class Game extends JPanel implements ActionListener {
	...
	private BufferedImage boss; // propre aux ships
	private BufferedImage player; //reste ici
	...
	public Game(BufferedImage bg) {
		height = bg.getHeight();
		width = bg.getWidth();
		bulletSpeed = 3.0; // BULLET SPEEEEEEEED
		playerDX=0;
		background=bg;
		playerDY=0;
		...
		playerY = 0.8*height - player.getHeight()/2;
	...
	private void playerUpdate() {
        ...
        if(playerX+player.getWidth()>width) { playerX = width - player.getWidth(); }
